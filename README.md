...
> **VPS / self-hosted?** This fork adds first-class VPS support — containers, any reverse proxy, agent-fulfilled Dreams, plan declaration, systemd hardening. **Start at [VPS-MODE.md](VPS-MODE.md)**; deploy units in [`deploy/`](deploy/).
